...
starting from low Q^2 ~ 0.15 GeV^2, which are based on a global analysis of the pi/K-A
...
2. Usage
The library consists of a C++ class named piIMParton (read ./piIMParton.h and ./piIMParton.cpp
for the details). piIMParton has a method piIMParton::getPDF(Iparton, X, Q2),
...
(So far, we let the charm quark distributions of the pion and the kaon to be zero!)
...
The file ./testPiPDF.cpp gives an example to get the parton momentum distributions
